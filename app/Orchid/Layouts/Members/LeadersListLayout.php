...
class LeadersListLayout extends Table
{
    /**
     * Data source.
     *
            ...
            TD::make('name', 'Name')
                ...
                ->render(function (User $user) {
                    return Link::make($user->name)
                        ->route('platform.leaders.edit', $user);
                }),
                ...
                ->render(function (User $user) {
                    return DropDown::make()
                        ...
                        ->list([
                            ...
                            Button::make(__('Demote'))
                                ->method('demote')
                                ->confirm(__('Are you sure you want to demote the user to a member role?'))
                                ->parameters([
                                    'id' => $user->id,
                                ])
                                ->icon('user-unfollow'),
